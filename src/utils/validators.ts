...
export const CriarFreteSchema = z.object({
  ...
  quantidade_sacas: z.number().int().nonnegative(),
  toneladas: z.number().nonnegative(),
  valor_por_tonelada: z.number().nonnegative(),
...
export const AtualizarFreteSchema = z
  .object({
    ...
    data_frete: DataFreteSchema.optional(),
    dataFrete: DataFreteSchema.optional(),
    quantidade_sacas: z.number().int().nonnegative().optional(),
    toneladas: z.number().nonnegative().optional(),
    valor_por_tonelada: z.number().nonnegative().optional(),
    receita: z.number().nonnegative().optional(),
    custos: z.number().nonnegative().optional(),
    resultado: z.number().optional(),
...
export const CriarPagamentoSchema = z.object({
  ...
  motorista_nome: z.string().min(3).transform(v => v.toUpperCase()).optional(),
  proprietario_nome: z.string().min(3).transform(v => v.toUpperCase()).optional(),
  periodo_fretes: z.string().transform(v => v.toUpperCase()),
  quantidade_fretes: z.number().int().nonnegative(),
  fretes_incluidos: z.string().optional(),
  total_toneladas: z.number().nonnegative(),
  valor_por_tonelada: z.number().nonnegative(),
...
export const AtualizarPagamentoSchema = z
  .object({
    ...
    motorista_nome: z.string().min(3).transform(v => v.toUpperCase()).optional(),
    proprietario_nome: z.string().min(3).transform(v => v.toUpperCase()).optional(),
    periodo_fretes: z.string().transform(v => v.toUpperCase()).optional(),
    quantidade_fretes: z.number().int().nonnegative().optional(),
    fretes_incluidos: z.string().optional(),
    total_toneladas: z.number().nonnegative().optional(),
    valor_por_tonelada: z.number().nonnegative().optional(),
